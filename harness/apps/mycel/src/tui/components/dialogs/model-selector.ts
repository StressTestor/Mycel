...
import { DEFAULT_OAUTH_PROVIDER_NAME, OAUTH_PROVIDER_DISPLAY_NAME } from '#/constant/app';
...
export function providerDisplayName(provider: string): string {
  if (provider === DEFAULT_OAUTH_PROVIDER_NAME) return OAUTH_PROVIDER_DISPLAY_NAME;
