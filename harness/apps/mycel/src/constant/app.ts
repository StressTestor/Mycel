...
export const PRODUCT_NAME = 'Mycel';
export const CLI_COMMAND_NAME = 'mycel';
...
export const MYCEL_HOME_ENV = 'MYCEL_HOME';
// Legacy home env from the kimi-code fork. Honored for one release with a
// deprecation warning; see getDataDir in utils/paths.ts.
export const LEGACY_HOME_ENV = 'KIMI_CODE_HOME';
export const KIMI_CODE_DATA_DIR_NAME = '.mycel';
...
// Human-readable label for the managed Kimi OAuth provider. This is the
// provider's identity, not the product brand, so it stays "Kimi Code" even
// though the app surface is now Mycel.
export const OAUTH_PROVIDER_DISPLAY_NAME = 'Kimi Code';
