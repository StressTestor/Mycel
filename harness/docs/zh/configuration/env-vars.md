...
| `KIMI_CODE_EXPERIMENTAL_CODEX_SUBSCRIPTION_AUTH` | 仅在当前进程启用实验性 Codex 订阅供应商 | `1`、`true`、`yes`、`on` |
| `KIMI_CODE_EXPERIMENTAL_DYNAMIC_WORKFLOWS` | 在交互式会话中启用主 Agent 的声明式 `Workflow` 工具 | `1`、`true`、`yes`、`on` |
