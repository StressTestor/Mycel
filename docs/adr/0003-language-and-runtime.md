...
- initial implementation should start with a small Rust crate boundary.
...
- exact crate split.
- whether to expose an MCP server, CLI only, or both.
- whether adapter packages live in this repo or separate repos after v0.8.
