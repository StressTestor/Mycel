...
# is tests/e2e/live-gate-model.sh (needs provider auth).
...
# --- 9. protected-path floor: a Write over the gate's own binary is denied ---
...
# --- 10. a benign Write to a normal file is still allowed ---
...
# --- 11. db integrity: a 0-byte (truncated) db must fail closed, not allow-all ---
